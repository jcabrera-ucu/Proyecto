namespace Library
{
    ...
    /// </summary>
    public class AtaqueHandler : BaseHandler
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="AtaqueHandler"/>. Esta clase procesa el mensaje "chau"
        /// y el mensaje "adiós" -un ejemplo de cómo un "handler" puede procesar comandos con sinónimos.
        /// </summary>
        /// <param name="next">El próximo "handler".</param>
        public AtaqueHandler(BaseHandler next) : base(next)
        {
        ...
        protected override bool InternalHandle(Message message, out string response)
        {
            if (CanHandle(message))
            {
                ...
                try
                {
                    ...
                    var resultado = ControladorJuego.HacerJugada(new Jugada(message.Id, TipoJugada.Ataque, c0));
                    response = $"¡{resultado}!";
                    return true;
                }
